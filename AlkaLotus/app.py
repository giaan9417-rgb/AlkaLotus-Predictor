...
# --- MODULE 3: ANALYTICS & REPORT (ĐÃ KHÔI PHỤC DỮ LIỆU CŨ VÀ SỬA LỖI INDENT) ---
elif page == "3. Phân tích & Xuất báo cáo":
    st.title("📊 Phân tích Kết quả & Xuất báo cáo")
    
    # --- KHÔI PHỤC: BẢNG THÔNG TIN CHI TIẾT HỢP CHẤT ---
...
    }
    # Sửa Indent: Đảm bảo các dòng dưới đây thẳng hàng
...
                
            if btn_analyze:
                # 1. Hiệu ứng AI Thinking (Đã thêm)
